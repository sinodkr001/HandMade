...
mongoose.connect("mongodb+srv://sinodkr001:qC7JNlpF0y3wLFfj@cluster0.hkncffl.mongodb.net/e-commerce");
...
const fetchUser = async (req,res,next)=>{
    ...
    if(!token) {
        ...
        try {
            ...
            res.status(401).send({errors:"please authenticate using a valid token1111"})
        }
    }
}
